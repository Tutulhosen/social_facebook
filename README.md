## SOCIAL PROJECT LIKE FACEBOOK
This   is a very simple social project

<img src="photo.PNG">

#### Our project features
-facebook registration with all validation
-login with authintication
-profile photo upload
-password change
-edit profile
-logout
-sohw recent login users
-quick login
